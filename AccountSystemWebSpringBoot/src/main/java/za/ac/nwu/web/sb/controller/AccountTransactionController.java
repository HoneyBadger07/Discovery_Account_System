...
public class AccountTransactionController {
    ...
    @GetMapping("/all")
    @ApiOperation(value = "Retrieve all the configured Account Transactions", notes = "Returns a list of Account Transactions")
    @ApiResponses(value = {
    ...
    @PostMapping("")
    @ApiOperation(value = "Create a new Account Transaction",notes = "Creates a new Account Transaction in the DB")
    @ApiResponses(value = {
